...
export async function getConfig() {
  return CommonConfigRegistry.get('psyche')?.read() || {}
}
...
export function resolveEnabled(runtimeConfig) {
  return listAssessments(runtimeConfig.enabledAssessments?.length ? { enabledIds: runtimeConfig.enabledAssessments } : {})
}
